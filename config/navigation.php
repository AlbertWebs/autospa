...
return [
    ...
    [
        ...
        'icon' => 'banknotes',
        'children' => [
            ['label' => 'Overview', 'route' => 'finance.index', 'permission' => 'reports.view'],
            ['label' => 'Income', 'route' => 'finance.income', 'permission' => 'reports.view'],
            ['label' => 'Expenses', 'route' => 'finance.expenses', 'permission' => 'reports.view'],
            ['label' => 'Profit & Loss', 'route' => 'finance.profit-loss', 'permission' => 'reports.view'],
            ['label' => 'Cash Payments', 'route' => 'payments.cash', 'permission' => 'payments.view'],
            ['label' => 'M-Pesa Payments', 'route' => 'payments.mpesa', 'permission' => 'payments.view'],
            ['label' => 'Card Payments', 'route' => 'payments.card', 'permission' => 'payments.view'],
            ['label' => 'Bank Payments', 'route' => 'payments.bank', 'permission' => 'payments.view'],
        ],
    ],
    ['section' => 'Insights'],
    [
