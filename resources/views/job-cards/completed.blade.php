<x-layouts.app>
    <x-slot name="header"><h1 class="text-2xl font-bold text-slate-900 dark:text-white">Completed Job Cards</h1></x-slot>
    @include('partials.crud.index-header', ['createRoute' => route('job-cards.create'), 'createLabel' => 'New Job Card', 'title' => 'Completed Job Cards'])
    <x-ui.card :padding="false">
        ...
        @if ($jobCards->isEmpty())<x-ui.empty-state title="No completed jobs" description="Completed job cards will appear here." />@endif
