<x-layouts.app>
    <x-slot name="header"><h1 class="text-2xl font-bold text-slate-900 dark:text-white">Job Cards</h1></x-slot>
    @include('partials.crud.index-header', ['createRoute' => route('job-cards.create'), 'createLabel' => 'New Job Card', 'title' => 'Job Cards'])
    <x-ui.card :padding="false">
        ...
        @if ($jobCards->isEmpty())<x-ui.empty-state title="No job cards yet" description="Create a job card to track service work." />@endif
