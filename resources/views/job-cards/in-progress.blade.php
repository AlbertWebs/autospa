<x-layouts.app>
    <x-slot name="header"><h1 class="text-2xl font-bold text-slate-900 dark:text-white">In Progress</h1></x-slot>
    @include('partials.crud.index-header', ['createRoute' => route('job-cards.create'), 'createLabel' => 'New Job Card', 'title' => 'In Progress'])
    <x-ui.card :padding="false">
        ...
        @if ($jobCards->isEmpty())<x-ui.empty-state title="No jobs in progress" description="Jobs currently being worked on will appear here." />@endif
