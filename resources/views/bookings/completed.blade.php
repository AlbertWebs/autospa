<x-layouts.app>
    <x-slot name="header"><h1 class="text-2xl font-bold text-slate-900 dark:text-white">Completed Bookings</h1></x-slot>
    @include('partials.crud.index-header', ['createRoute' => route('bookings.create'), 'createLabel' => 'New Booking', 'title' => 'Completed Bookings'])
    <x-ui.card :padding="false">
        ...
        @if ($bookings->isEmpty())<x-ui.empty-state title="No completed bookings" description="Completed bookings will appear here." />@endif
