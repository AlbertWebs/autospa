<x-layouts.app>
    <x-slot name="header"><h1 class="text-2xl font-bold text-slate-900 dark:text-white">Walk-In Bookings</h1></x-slot>
    @include('partials.crud.index-header', ['createRoute' => route('bookings.create'), 'createLabel' => 'New Booking', 'title' => 'Walk-In Bookings'])
    <x-ui.card :padding="false">
        ...
        @if ($bookings->isEmpty())<x-ui.empty-state title="No walk-ins" description="Walk-in bookings will appear here." />@endif
