<x-layouts.app>
    <x-slot name="header"><h1 class="text-2xl font-bold text-slate-900 dark:text-white">Pending Bookings</h1></x-slot>
    @include('partials.crud.index-header', ['createRoute' => route('bookings.create'), 'createLabel' => 'New Booking', 'title' => 'Pending Bookings'])
    <x-ui.card :padding="false">
        ...
        @if ($bookings->isEmpty())<x-ui.empty-state title="No pending bookings" description="Pending bookings will appear here." />@endif
