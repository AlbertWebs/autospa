<x-layouts.app>
    <x-slot name="header"><h1 class="text-2xl font-bold text-slate-900 dark:text-white">Weekly Report</h1></x-slot>
    <div class="mb-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <x-ui.stat-card label="Week" :value="isset($report['period']) && is_array($report['period']) ? implode(' – ', $report['period']) : ($report['period'] ?? 'N/A')" />
