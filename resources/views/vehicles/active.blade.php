<x-layouts.app>
    <x-slot name="header"><h1 class="text-2xl font-bold text-slate-900 dark:text-white">Active Vehicles</h1></x-slot>
    @include('partials.crud.index-header', ['createRoute' => route('vehicles.create'), 'createLabel' => 'Add Vehicle', 'title' => 'Active Vehicles'])
    <x-ui.card :padding="false">
        ...
        @if ($vehicles->isEmpty())<x-ui.empty-state title="No active vehicles" description="Vehicles currently in service will appear here." />@endif
