<x-ui.index-page
    ...
    subtitle="Vehicles currently in service or on the shop floor."
...
>
    <x-ui.data-table
        ...
        empty-title="No active vehicles"
        empty-description="Vehicles currently in service will appear here."
    >
        <x-slot name="header">
