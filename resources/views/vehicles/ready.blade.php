<x-layouts.app>
    <x-slot name="header"><h1 class="text-2xl font-bold text-slate-900 dark:text-white">Ready for Pickup</h1></x-slot>
    @include('partials.crud.index-header', ['createRoute' => route('vehicles.create'), 'createLabel' => 'Add Vehicle', 'title' => 'Ready for Pickup'])
    <x-ui.card :padding="false">
        ...
        @if ($vehicles->isEmpty())<x-ui.empty-state title="No vehicles ready" description="Completed vehicles awaiting pickup will appear here." />@endif
