<x-ui.index-page
    ...
    subtitle="Completed vehicles awaiting customer collection."
...
>
    <x-ui.data-table
        ...
        empty-title="No vehicles ready"
        empty-description="Completed vehicles awaiting pickup will appear here."
    >
        <x-slot name="header">
