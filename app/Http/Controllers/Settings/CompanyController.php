...
class CompanyController extends Controller
{
    public function edit(): View
    {
        ...
        return view('settings.company.edit', [
            ...
            'commissionPayoutCycle' => CommissionSettings::payoutCycle(),
            'commissionPayoutCycleOptions' => CommissionSettings::payoutCycleOptions(),
    ...
    public function update(UpdateCompanyRequest $request): RedirectResponse
    {
        ...
        $commissionPayoutCycle = $validated['commission_payout_cycle'] ?? CommissionSettings::PAYOUT_DAILY;
        ...
        unset(
            ...
            $validated['commission_payout_cycle'],
        ...
        Setting::setValue('commission', 'payout_cycle', $commissionPayoutCycle, null, 'string');
